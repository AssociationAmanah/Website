    ...
    <div className="pt-20 pb-16 px-4 max-w-5xl mx-auto">
      ...
      >
        <a
          ...
          className="flex items-center p-6 rounded-2xl shadow-md bg-[#FDF7E7] hover:bg-[#faedcc] transition-all duration-300"
        >
          <Instagram className="text-pink-600 w-8 h-8 mr-4" />
          <div>
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center p-6 rounded-2xl shadow-md bg-[#EEF4FF] hover:bg-[#dbe9ff] transition-all duration-300"
        >
          <Facebook className="text-blue-600 w-8 h-8 mr-4" />
          <div>
      ...
      >
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center px-6 py-3 rounded-full bg-[#2e8b57] text-white hover:bg-[#256e47] transition-colors"
        >
